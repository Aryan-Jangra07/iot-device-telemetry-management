    ...
    <div className="flex bg-slate-950 min-h-screen text-slate-100 font-sans">
      ...
      <main className="flex-1 ml-64 p-8 relative overflow-hidden">
        <header className="mb-10 relative z-10">
          ...
          <h2 className="text-4xl font-black text-white tracking-tighter">Analytics</h2>
        </header>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10 relative z-10">
          {stats.map((stat, i) => (
            <div key={i} className="bg-slate-900/50 border border-slate-800 p-6 rounded-3xl backdrop-blur-sm hover:border-slate-700 transition-all">
        ...
        <div className="grid lg:grid-cols-2 gap-8 relative z-10">
          <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-3xl h-80 flex flex-col items-center justify-center text-center">
            <div className="bg-slate-800 p-4 rounded-2xl mb-4">
              <TrendingUp className="w-8 h-8 text-blue-500" />
            </div>
            <h3 className="text-lg font-bold text-white mb-2">Data Trends Coming Soon</h3>
          ...
          <div className="bg-slate-900/50 border border-slate-800 p-8 rounded-3xl h-80 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-lg font-bold text-white mb-2">Distribution Analysis</h3>
